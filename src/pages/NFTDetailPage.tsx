...
import { Clock, Eye, Heart, Share2, MoreHorizontal, ShieldCheck, Tag, Activity } from "lucide-react";
...
export function NFTDetailPage() {
  ...
  const moreFromCollection = MOCK_NFTS.filter(n => n.collection === nft.collection && n.id !== nft.id).slice(0, 4);
  return (
        ...
        <div className="space-y-8">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <Link to={`/collection/${nft.collection}`} className="text-primary font-medium hover:underline">
                {nft.collection}
              </Link>
            ...
            <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground mb-8">
              <div className="flex items-center gap-2">
                ...
                <span>Owned by <span className="text-foreground font-medium">{nft.owner}</span></span>
              </div>
            ...
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm overflow-hidden">
              <div className="p-6 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button size="lg" className="flex-1 h-12 text-lg font-semibold bg-gradient-to-r from-blue-600 to-violet-600 hover:shadow-glow transition-all">
                    Buy Now
                  </Button>
